    ...
    return (
      <>
        ...
        {tokenExists && (
          <AdminLayout>
            <main
              className='overflow-y-scroll font-quest
                                md:ml-32'>
              <div className='px-10 my-10 mx-auto'>
                <h1 className='text-3xl text-primary md:ml-20 md:mt-10 font-quest'>
                  SERVICE DETAILS
                </h1>
                <div className='flex mt-4 md:ml-20 lg:mr-44'>
                  <div className='container mt-8 bg-[#ebe8e8] rounded-lg'>
                    <div className=' ml-8 mb-2 mr-20 mt-4 '>
                      <h1 className='text-xl md:text-2xl text-[#1b1b60] mb-6'>
                        Ship Rocket
                      </h1>
                      <div className='flex mb-2'>
                        <h2 className='text-lg w-2/3 md:w-96 text-[#b56016] flex items-center'>
                          Services
                        </h2>
                        <input
                          type='text'
                          className='bg-[#ebe8e8] text-[#1b1b60] text-lg w-5/6 md:w-96 p-2.5'
                          value='Shipping, Invoices'
                          disabled
                          readonly
                        />
                      </div>
                      <div className='flex mb-2'>
                        <h2
                          for='last_name'
                          className='w-2/3 md:w-96 text-lg text-[#b56016] flex items-center'>
                          Payment
                        </h2>
                        <input
                          type='text'
                      ...
                      <div className='flex mb-2'>
                        ...
                        <input
                          type='text'
                          className='bg-[#ebe8e8]  text-[#1b1b60] text-lg w-5/6 md:w-96 p-2.5'
                          value='sales.iclothing@gmail.com'
                          disabled
                          readonly
                        />
                      </div>
                    ...
                    <div className=' ml-8 mb-2 mr-20 mt-4 '>
                      ...
                      <div className='flex mb-2'>
                        ...
                        <input
                          type='text'
                          className='bg-[#ebe8e8]  text-[#1b1b60] text-lg w-5/6 md:w-96 p-2.5'
                          value='RzE1JEOSepBhh8g5LHXDqzsF'
                          disabled
                          readonly
                        />
                      </div>
