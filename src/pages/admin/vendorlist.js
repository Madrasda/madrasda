            ...
            {tokenExists &&
                <AdminLayout>
                    ...
                    >
                       ...
                       md:ml-20 m-5">MY VENDORS</h1>
                            <div className="flex flex-wrap justify-start md:ml-20">
                                <div
                                    className="lg:w-1/6 md:w-3/4 p-4 w-full lg:h-80 md:h-96 h-80 flex items-center justify-center m-5 rounded duration-200 ease-in-out">
                                    <Link href="#">
                                ...
                                {vendors !== null &&
                                    vendors.map((vendor, index) => (
                                        <Grow key={uuidv4()} in timeout={(index + 1) * 500 % (500 * 5)}>
                                            <div key={uuidv4()}
                    ...
                    <span className="w-full ml-5 flex justify-end">
                      <CloseConfirm vendor={true} delete={(e) => {
