                ...
                <form>
                  ...
                  <div>
                    ...
                    <input
                      type='text'
                      className={
                        "w-full p-2 text-bg rounded-md outline-none text-sm transition duration-150 ease-in-out mb-4"
                      }
                      id='company-url'
                      placeholder='example@example.com'
                    />
                  ...
                  <div>
                    <label htmlFor='vendor-name' className='text-white'>
                      Vendor Display Name
                    </label>
                    <input
                      type='text'
                  ...
                  <div>
                    <label htmlFor='company-url' className='text-white'>
                      Company URL
                    </label>
                    <input
                      type='text'
                  ...
                  <div>
                    <label htmlFor='gst-in' className='text-white'>
                      GST IN
                    </label>
                    <input
                      type='text'
