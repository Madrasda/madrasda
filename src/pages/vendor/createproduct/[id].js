...
export default function CreateTemplate(props) {
    ...
    return (
        <>
            ...
            <VendorLayout message={message} severity={severity} state={open} setState={setOpen}>
                        ...
                        lg:flex-row">
                                <div className='flex flex-col items-center bg-[#F0F0F0] p-4'>
                                    <div className='flex mb-8'>
                                        <button
                                            className={`text-xs rounded-full border-2 px-3 py-2 mx-1 border-gray ${position === "Center" ? 'bg-primary text-white' : 'bg-off-white'}`}
                                            value="Center" onClick={(e) => setPosition(e.target.value)}>Center
                                        </button>
                                        <button
                                            className={`text-xs rounded-full border-2 px-3 py-2 mx-1 border-gray ${position === "Top Left Corner" ? 'bg-primary text-white' : 'bg-off-white'}`}
                                            value="Top Left Corner" onClick={(e) => setPosition(e.target.value)}>Top
                                            Left Corner
                                        </button>
                                        <button
                                            className={`text-xs rounded-full border-2 px-3 py-2 mx-1 border-gray ${position === "Bottom Left Corner" ? 'bg-primary text-white' : 'bg-off-white'}`}
                                            value="Bottom Left Corner"
                                            onClick={(e) => setPosition(e.target.value)}>Bottom Left Corner
                                        </button>
                                        <button
                                            className={`text-xs rounded-full border-2 px-3 py-2 mx-1 border-gray ${position === "Top Right Corner" ? 'bg-primary text-white' : 'bg-off-white'}`}
                                            value="Top Right Corner" onClick={(e) => setPosition(e.target.value)}>Top
                                            Right Corner
                                        </button>
                                        <button
                                            className={`text-xs rounded-full border-2 px-3 py-2 mx-1 border-gray ${position === "Bottom Right Corner" ? 'bg-primary text-white' : 'bg-off-white'}`}
                                            value="Bottom Right Corner"
                                            onClick={(e) => setPosition(e.target.value)}>Bottom Right Corner
                                        </button>
                                    </div>
                          ...
                          lg:pl-10 lg:py-6 lg:mt-0 lg:w-1/2">
                                    ...
                                    <div className='mt-6'>
                                        ...
                                        <div className='flex flex-row'>
                                            <button
                                                className={`text-sm rounded-full border-2 border-bg px-7 py-2 mr-2 ${front ? "bg-primary text-white" : ""}`}
                                                onClick={() => setFront(true)}>Front
                                            </button>
                                            <button
                                                className={`text-sm rounded-full border-2 border-bg px-7 py-2 mr-2 ${!front ? "bg-primary text-white" : ""}`}
                                                onClick={() => setFront(false)}>Back
                                            </button>
                                        </div>
                                    </div>
