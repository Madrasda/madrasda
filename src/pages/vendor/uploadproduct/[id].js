                    ...
                    <div className="mt-20 px-5 md:my-10 mx-auto">
                        ...
                        <div className="md:ml-20 lg:ml-32">
                            ...
                            <div className="ml-2">
                                ...
                                <textarea id="comment" rows="4"
                                          className="bg-white border border-[#D9D9D9] text-sm rounded-lg focus:ring-primary focus:border-[#D9D9D9] block w-full p-2.5"
                                          placeholder="Enter the description for your product" required
                            ...
                            {template &&
                                <div className="mb-6 ml-2">
                                    ...
                                    <div className="flex flec col ml-12 ">
                                        {template && <img className="w-36 rounded-lg"
                                                          src={template.frontDesignImage || template.backDesignImage}
                                                          alt="picture"></img>}
                                    </div>
                                            ...
                                            return (
                                                <div className='my-4 space-x-5 items-center px-2' key={color.id}>
                                                    <button
                                                        ...
                                                        handleColorSelection({id: color.id, hexValue: color.hexValue})
                                                    }}
                                    ...
                                    <div className="ml-2">
                                        <label htmlFor="dropzone-file"
                                            ...
                                            <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                                <svg aria-hidden="true" className="w-10 h-10 mb-3 text-black-400"
                                                ...
                                                <p className="mb-2 text-sm text-black"><span className="font-semibold">Click to upload</span>
                                                </p>
                                            </div>
                                            <input id="dropzone-file" type="file" accept='image/jpeg' className="hidden"
                                                   onChange={(e) => {
                                        ...
                                        return (
                                            <div key={uuidv4()} className="relative">
                                                <button
                                                    ...
                                                    p-3 rounded-lg hover:shadow-lg bg-primary text-white">{item}</button>
                                            </div>
                                        )
                                    })
                                }
                                ...
                                <div className='space-x-3 justify-center flex flex-wrap'>
                                    {
                                        productImages.map((image) => {
                                            if (image.color === currenId) {
                                                return (
                                                    <div key={uuidv4()} onClick={() => handleRemove(image)}>
                       ...
                       lg:mr-12"></hr>
                        ...
                        lg:ml-32">
                            ...
                            <div className="grid gap-3 ml-2 mb-2 md:grid-cols-2 " style={{width: "40rem"}}>

                                <div>
                                    <TextField type="numeric" className={'text-2xl w-72'}
                                               label={'Maximum retail Price (₹)'}
                                               placeholder="₹" required onChange={(e) => setTotal(e.target.value)}/>
                                </div>
                                <div>
                                    <TextField type="numeric" className='text-2xl w-72 text-bold text-black'
                                               placeholder="₹" disabled value={basePrice} label={"Base Price (₹)"}/>
                                </div>
                                <div>

                                    <TextField type="numeric"
                                               className="text-2xl w-72" label={'Discount / Offer %'}
                                               placeholder="%" required onChange={(e) => setDiscount(e.target.value)}/>
                                </div>
                        ...
                        <div className=" mt-14 flex justify-center ">
                            <button type="button" onClick={() => uploadProduct()}
                                    className="text-white bg-primary hover:bg-blue-800 focus:outline-none focus:ring-4
         focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2">Upload Product
                            </button>
                        </div>
                    </div>
                </main>
