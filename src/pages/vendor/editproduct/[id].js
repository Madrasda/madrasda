								...
								{template && (
									<div className='my-6 ml-2'>
										...
										<div className='flex text-xl text-primary'>
											{JSON.parse(template.frontDesignPlacement) ||
												JSON.parse(template.backDesignPlacement)}
										</div>
									</div>
								)}
							</div>
											...
											colors.map((color) => {
												return (
													<div
														...
														<p className='text-[12px] pt-2 mx-auto'>{color.color}</p>
													</div>
												);
											})}
									</div>
                      ...
                      selectedColors.map((color) => {
													...
													onChange={(e) => {
														...
														setProductImages((images) => {
															const image = [
																...
																{
																	color: currenId,
																	imageUrl: getDataUrlFromFile(e.target.files[0]),
																},
															]
											...
											if (image.color === currenId) {
												return (
													<div key={uuidv4()} className={'text-end'}>
														...
														<img className='h-72 aspect-auto ' alt={'mockup-image'} src={image.imageUrl}/>
													</div>
												);
											}
										})}
                       ...
                       lg:mr-12'></hr>
                        ...
                        lg:ml-32'>
								...
								<h1 className='ml-2 text-lg mt-4 font-bold'>NOTE: Kindly email the design in high quality with a
									resolution of 3000 x 3000 to admin at backend@madrasda.com</h1>
							</div>
