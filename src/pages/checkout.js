      ...
      <ClientLayout client={client}>
        <main>
          <div className='min-w-screen min-h-screen py-5'>
            ...
            <div className='w-full border-gray-200 px-5 py-10 text-gray-800 pr-12'>
              <div className='w-full'>
                <div className='-mx-3 md:ml-20 md:flex items-start'>
                  ...
                  <div className='px-3 md:w-5/12'>
                    ...
                    <hr className='h-px my-6 border-[#d2d1d1] border-1 '></hr>
                    <div className='bg-white px-6 py-3 rounded border border-border'>
                      <div className='mb-6 pb-6 text-lg border-b border-border text-black'>
                      ...
                      <div className='border-b border-gray md:border-none text-gray-800 text-xl'>
                        <div className='w-full flex items-center'>
                          <div className='flex-grow'>
                            <span className='text-gray-600'>Total</span>
                            <p className='text-sm'>Including all taxes</p>
                          </div>
                          <div className='pl-3'>
                            <span className='font-medium text-sm'>INR</span>{" "}
                  ...
                  <div className='px-3 md:w-7/12 lg:pr-10'>
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className='flex justify-end'>
                        <button
                          type='submit'
                          className={`text-white shadow-lg shadow-shadowGrey bg-primary hover:bg-accent 
