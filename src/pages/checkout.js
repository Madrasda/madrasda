...
export default function Checkout() {
    ...
    const handleChange = (event) => {
        ...
        setPincode(oldText => {
            setTimeout(() => {
                if (text.length === 6) {
                    setError(false);
                    axios.get("http://localhost:8080/api/payment/getShippingCharges/" + text, {
                        headers: {
    ...
    const handleSubmit = event => {
        ...
        axios.post("http://localhost:8080/api/payment/createOrder", transaction, {
            headers: {
                Authorization: "Bearer " + localStorage.getItem("token")
            }
        }).then(response =>
            ...
            <ClientLayout>
                <main>
                    <div className="min-w-screen min-h-screen bg-gray-50 py-5">
                        <div className="px-5">
                            <div className="mb-2">
                                <a href="#" className="focus:outline-none hover:underline text-gray text-sm"><i
                            ...
                            <div className="mb-5 md:ml-20 text-gray-400">
                                <a href="./index.js"
                                   className="focus:outline-none hover:underline text-gray-500">Home</a> / <span
                        ...
                        <div className="w-full bg-white border-gray-200 px-5 py-10 text-gray-800 pr-12">
                            <div className="w-full">
                                <div className="-mx-3 md:ml-20 md:flex items-start">
                                    ...
                                    <div className="px-3 md:w-5/12">
                                        ...
                                        <div className="mb-6 pb-6 text-lg border-b border-[#D9D9D9] text-black">
                                            ...
                                            <div className="w-full flex items-center">
                                                ...
                                                <div className="pl-3">
                                                    <span className="font-medium">
                                                        {shippingCharges === -1 ?
                                                            <h4 className={"text-red"}>Enter a valid
                                                                Pincode</h4> : shippingCharges === 0 ? "FREE" : "₹" + shippingCharges}
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="w-full flex my-3 items-center">
                                                ...
                                                <div className="pl-3">
                                                    <span className="font-medium">₹{subTotal * 5 / 100}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <div className="w-full flex items-center">
                                                ...
                                                <div className="pl-3">
                                                    ...
                                                    className="font-medium text-2xl">₹{subTotal * (105.0 / 100.0) + (shippingCharges === -1 ? 0 : shippingCharges)}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <h2 className="ml-2 mb-6 title-font font-medium text-xl">Shipping
                                        Details</h2>
