      ...
      >
        ...
        <div className="container mt-8 bg-[#D9D9D9] rounded-lg w-full">
                        <div className=" ml-8 mb-2 mr-20 mt-4 ">
                            ...
                            <div className="flex mb-2">
                                <h2 className="text-lg mb-2 font-medium w-2/6 md:w-96 text-black flex items-center">Item Price</h2>
                            ...
                            <div className="flex mb-2">
                                <h2 for="company" className="mb-2 text-lg w-2/6 md:w-96 font-medium text-black flex items-center">Reason for Replacement</h2>
                                <input type="text" className="bg-[#D9D9D9] border-b  border-black text-black text-sm w-4/6 md:w-96 p-2.5 cursor-default " placeholder="text" readOnly/>
                            </div>
                            <h2 for="company" className="mb-2 text-lg w-2/6 md:w-96 font-medium text-black">Comments</h2>
                            <input type="text" id="large-input" className="block border-2 border-gray rounded-lg w-full p-14 text-black bg-[#D9D9D9] cursor-default" placeholder="Explanation....." readOnly/>
                            <div className="mb-6 mt-6 ml-2">
                                ...
                                <img className="ml-6 w-36 rounded-lg" src="https://cdn.discordapp.com/attachments/981618787491127306/1078972451930771486/Group_85.png" alt="picture"></img>
                                </div>
                            </div>
                        </div>
                    </div>
