...
export default function TermsConditionsModal() {
  ...
  return (
    <div>
      <button
        className='text-primary bg-none border border-primary cursor-pointer w-full px-4 py-2 rounded-md'
          ...
          <Text id='modal-description'>
            <div className='font-quest text-base text-black flex flex-wrap justify-start items-center text-justify px-3 w-full'>
              <p className='text-3xl font-bold text-left'>
                Terms and Conditions for a Marketplace Where Content Creators
              ...
              your use of our website and services, so please read them
              ...
              <br />
              You represent and warrant that you are the owner of all content
              and intellectual property rights in any products, designs, or
              merchandise that you offer for sale on our marketplace. You agree
              ...
              security of your account and for any activity that occurs under
              your account.
              <br />
              <br />
              ...
              <p className='font-bold text-center w-full'>
                ...
                sell their merchandise ("Merchandise"). By accessing or using
                the Marketplace, Creators agree to be bound by this Agreement.
                The Marketplace is operated by [Marketplace Operator], a [State]
              ...
              Merchandise on the Marketplace. Creators warrant and represent
              that all Merchandise offered for sale on the Marketplace is
              original work, and that they own or have obtained all necessary
              rights to the content and intellectual property contained therein.
              Creators are responsible for ensuring that their Merchandise
              complies with all applicable laws, rules, and regulations.
              <br />
              <br />
              <p className='italic'>Fees and Payments</p>
              <br />
              Creators shall pay Operator a transaction fee of [Percentage] of
              the sale price for each item of Merchandise sold through the
              Marketplace. Creators are responsible for setting the sale price
              for their Merchandise, and may adjust the sale price at any time,
              subject to the Marketplace's policies. Payment for Merchandise
              sold on the Marketplace shall be processed through Operator's
              payment processing system, and Creators shall receive payment for
              their sales in accordance with the Marketplace's payment policies.
              <br />
              <br />
              <p className='italic'>Refunds and Returns</p>
              <br />
              Our Platform Madras Da is solely responsible for providing any
              necessary customer support, refunds, returns, and exchanges
              related to their Merchandise. Creators must comply with the
              Marketplace's policies regarding refunds and returns, and must
              respond promptly to any customer inquiries or complaints. Creators
              shall indemnify and hold Operator harmless from any and all
              liability arising from Creators' handling of refunds, returns, and
              exchanges.
              <br />
              <br />
              <p className='italic'>Intellectual Property</p>
              <br />
              Creators retain all rights to the content and intellectual
              property contained in their Merchandise, subject to the license
              granted to Operator in this Agreement. Creators grant Operator a
              non-exclusive, worldwide, royalty-free license to use, reproduce,
              distribute, and display the content and intellectual property
              contained in their Merchandise for the purpose of promoting and
              operating the Marketplace.
              <br />
              <br />
              <p className='italic'>Prohibited Content</p>
              <br />
              Creators are prohibited from offering for sale any Merchandise
              that contains content that is illegal, obscene, defamatory, or
              infringes on the intellectual property or privacy rights of
              others. Operator reserves the right to remove any Merchandise from
              the Marketplace that violates this provision.
              <br />
              <br />
              ...
              <br />
              Operator shall not be liable to Creators or any third party for
              ...
              with the laws of the State of Tamilnadu India, without regard to
              ...
              <p className='font-bold text-center w-full'>
                ...
                they have read and understand this Agreement and agree to be
                bound by its
              </p>
            </div>
          </Text>
