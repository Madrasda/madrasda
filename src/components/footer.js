...
export default function Footer() {
  return (
    <footer className="bg-white text-gray body-font font-algeria text-sm font-bold z-30">
        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div className="flex justify-center">
              ...
              <button className="flex-shrink-0 flex items-center text text-white bg-primary border-0 py-2 px-2
               focus:outline-none hover:bg-[#560b21] rounded">Subscribe</button>
            </div>
          </div>
        </div>
      </div>
