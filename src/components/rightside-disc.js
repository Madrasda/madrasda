            ...
            <span
              ...
              <div className='flex flex-col w-full'>
                <Link href={`/products/${id}`}>
                  <h1
                     className='font-prompt italic font-black text-2xl tracking-widest text-logo flex justify-end pr-10 text-center my-3 hover:text-4xl transition-all ease-in-out duration-500 absolute top-0 right-0'>
                    {name}
                  </h1>
                </Link>
                  ...
                  <div className="flex justify-between items-center mt-10">
                     <div className='absolute mt-10'>
                        <Link href={`products/${id}`} className='relative'>
                           ...
                           />
                           <div
                              className='w-[140px] h-[140px] overflow-hidden absolute -top-[70px] left-[5px] xl:top-1/2 xl:left-1/2 xl:transform xl:-translate-x-1/2 xl:-translate-y-1/2 bg-cover objects-center rounded-full'>
                              <Image
                     ...
                     return (
                        <div
                           ...
                           <Link href={`/productDetails/${prod.id}`}>
                              ...
                              <div className='mt-4 flex flex-col'>
                                 <h2
                                    className='text-black title-font text-[15px] md:text-[20px] xl:text-lg font-medium'>
                                    {prod.name}
                                 </h2>
