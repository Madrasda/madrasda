        ...
        <Modal.Body>
          <Text id='modal-description'>
            <div className='font-quest text-base text-black flex flex-wrap justify-start items-center text-justify px-3 w-full'>
              ...
              structure for creators ("Creator") who sell their products through
              a commission-based model ("Commission Model") with Madras Da Owned
              By I Clothing. By accessing or using the Commission Model,
              Creators agree to be bound by this Agreement.
              <br />
              <br />
              <p className='italic'>Commission Basis</p>
              <br />
              The Commission Model enables Creators to sell their products
              through the Company's platform, and receive payment for such
              products based on a commission structure. The commission
              ...
              Model shall be made on a monthly basis, within 30 days after the
              end of the month in which the sale was made. Payment shall be made
              via the payment method selected by the Creator during
              registration, subject to the Company's payment policies.
              <br />
              <br />
              <p className='italic'>Calculation of Payment</p>
              <br />
              Payment to Creators for their products sold through the Commission
              Model shall be calculated based on the Commission Percentage and
              the net revenue ("Net Revenue") earned by the Company from the
              sale of such products. The Net Revenue is defined as the gross
              revenue received by the Company from the sale of the products,
              less any taxes, shipping, refunds, and chargebacks.
              <br />
              <br />
              <p className='italic'>Reporting</p>
              <br />
              The Company shall provide the Creator with regular reports on the
              sales of their products through the Commission Model, including
              the total sales revenue, the Commission Percentage, and the
              resulting commission payments due to the Creator.
              <br />
              <br />
              ...
              payment for any outstanding commission payments earned prior to
              ...
              with the laws of the State of Tamilnadu, without regard to its
              ...
              <p className='text-center font-bold w-full'>
                ...
                that they have read and understand this Agreement and agree to
