...
const CartItem = ({id, product, qty}) =>{
    ...
    return (
        <div className="w-full flex items-center hover:bg-off-white rounded-lg p-7">
                    ...
                    <div className="flex items-center mt-4 h-4 w-16">
                        <div className="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
                            <button onClick={decrementHandler}
                                    className="bg-white flex text-center border border-gray text-primary hover:text-primary hover:bg-gray h-7 w-16 rounded-l cursor-pointer">
                                <span className="m-auto text-xs font-bold"> - </span>
                            </button>
                            <input
                                className="border border-gray focus:outline-none text-center h-7  w-full bg-white font-semibold text-xs hover:text-primary focus:text-primary md:text-basecursor-default flex items-center text-primary outline-none"
                                value={qty} onChange={onChangeHandler}></input>
                            <button onClick={incrementHandler}
                                    className="bg-white flex text-center border border-gray text-primary hover:text-primary hover:bg-gray h-7 w-16 rounded-r cursor-pointer">
                                <span className="m-auto text-xs font-bold"> + </span>
                            </button>
                        </div>
                    </div>
            ...
            <div>
                <span className="font-medium text-black text-xl">₹{product.total}</span>
            </div>
            <div>
