        ...
        <div className="container mt-8 bg-[#D9D9D9] rounded-lg w-full">
                        <div className=" ml-8 mb-2 mr-20 mt-4 ">
                            ...
                            <div className="flex mb-2">
                                ...
                                <input type="text" className="bg-[#D9D9D9] border-b border-black text-black text-sm w-4/6 md:w-96 p-2.5 " placeholder="Name"/>
                            </div>
                            <div className="flex mb-2">
                                <h2 className="text-lg mb-2 font-medium w-2/6 md:w-96 text-black flex items-center">Order ID</h2>
                                <input type="text" className="bg-[#D9D9D9] border-b border-black text-black text-sm w-4/6 md:w-96 p-2.5 cursor-default" placeholder="ID"/>
                            </div>
                            <div className="flex mb-2">
                                <h2 className="text-lg mb-2 font-medium w-2/6 md:w-96 text-black flex items-center">Product Details</h2>
                                <input type="text" className="bg-[#D9D9D9] border-b border-black text-black text-sm w-4/6 md:w-96 p-2.5 cursor-default" placeholder="T-Shirt"  />
                            </div>
                            <div className="flex mb-2">
                                <h2 className="text-lg mb-2 font-medium w-2/6 md:w-96 text-black flex items-center">Item Price</h2>
                                <input type="text" className="bg-[#D9D9D9] border-b border-black text-black text-sm w-4/6 md:w-96 p-2.5 cursor-default" placeholder="₹"  />
                            </div>
                            <div className="flex mb-2">
                            ...
                            <div className="flex mb-2">
                                ...
                                <input type="text" className="bg-[#D9D9D9] border-b  border-black text-black text-sm w-4/6 md:w-96 p-2.5 cursor-default " placeholder="text"  />
                            </div>
